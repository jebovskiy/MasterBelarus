-- 008: notifications_log + RPC find_orders_nearby + storage bucket
...
CREATE INDEX idx_nl_telegram_id ON public.notifications_log (telegram_id);
CREATE INDEX idx_nl_sent_at     ON public.notifications_log (sent_at);

-- RPC: find orders nearby using PostGIS
