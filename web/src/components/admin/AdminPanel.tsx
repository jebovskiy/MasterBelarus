        ...
        {!token && (
          <div className="mb-4">
            <input
              ...
              className="w-full rounded-btn border border-app-border bg-white p-3 text-sm"
            />
        ...
        <div className="flex gap-2 mb-4 overflow-x-auto pb-2">
          {TABS.map((t) => (
            <button
              ...
              className={`flex items-center gap-1.5 px-4 h-9 rounded-full text-sm font-semibold whitespace-nowrap transition ${
                tab === t.key ? 'bg-primary-tint text-primary' : 'bg-white text-text-muted border border-app-border'
              }`}
            >
              <span>{t.icon}</span>
              {t.label}
              ...
              <div key={order.id} className="bg-white p-4 rounded-bento shadow-card">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <select
                    ...
                    className="rounded-btn border border-app-border bg-white px-2 py-1 text-xs"
                  >
